...
This folder contains a sample run of the `understand-repo` skill against a small Python CLI repo, so you can preview the artifact before installing.
...
In Codex, you can explicitly mention `$understand-repo`. In Claude Code, you can explicitly invoke `/skill understand-repo`.
